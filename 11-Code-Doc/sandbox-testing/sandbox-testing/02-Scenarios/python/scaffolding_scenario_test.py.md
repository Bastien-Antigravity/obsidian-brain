---
source: sandbox-testing/02-Scenarios/python/scaffolding_scenario_test.py
workspace: sandbox-testing
type: code-mirror
status: auto-generated
last_sync: 2026-09-17 06:24:02.348045
...
# Mirror: scaffolding_scenario_test.py
...
- [[sandbox-testing/sandbox-testing/04-Mock-Provider/main.go.md|main]] (function: calls)

### 🔌 Consumers (Inbound)
- [[sandbox-testing/sandbox-testing/02-Scenarios/python/scaffolding_scenario_test.py.md|BASE_SCRIPTS_DIR]] (constant: belongs_to)
- [[sandbox-testing/sandbox-testing/02-Scenarios/python/scaffolding_scenario_test.py.md|DOCKER_DEPLOY_DIR]] (constant: belongs_to)
...
- [[sandbox-testing/sandbox-testing/02-Scenarios/python/scaffolding_scenario_test.py.md|test_scaffolding_scenario_full_lifecycle]] (function: belongs_to)
<!-- SYNC:END -->
