...
### 🔌 Consumers (Inbound)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/agents/fleetarchitect.py.md|FleetArchitectAgent]] (class: belongs_to)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/agents/fleetarchitect.py.md|__init__]] (function: belongs_to)
