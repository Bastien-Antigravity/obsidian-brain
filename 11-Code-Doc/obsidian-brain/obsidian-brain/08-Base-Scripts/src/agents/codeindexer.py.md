...
### 🔌 Consumers (Inbound)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/agents/codeindexer.py.md|CodeIndexerAgent]] (class: belongs_to)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/agents/codeindexer.py.md|__init__]] (function: belongs_to)
