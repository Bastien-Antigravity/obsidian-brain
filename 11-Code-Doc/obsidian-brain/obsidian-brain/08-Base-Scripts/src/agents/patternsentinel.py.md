...
### 🔌 Consumers (Inbound)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/agents/patternsentinel.py.md|PatternSentinelAgent]] (class: belongs_to)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/agents/patternsentinel.py.md|__init__]] (function: belongs_to)
