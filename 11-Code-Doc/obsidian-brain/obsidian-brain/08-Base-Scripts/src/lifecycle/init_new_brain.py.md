...
### 🔌 Consumers (Inbound)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/lifecycle/init_new_brain.py.md|init_brain]] (function: belongs_to)
- [[obsidian-brain/obsidian-brain/08-Base-Scripts/src/lifecycle/init_new_brain.py.md|main]] (function: belongs_to)
<!-- SYNC:END -->
